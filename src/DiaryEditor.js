...
const DiaryEditor = () => {
    ...
    return (
        <div className='DiaryEditor'>
            <h2>오늘의 일기</h2>
            <div>
                <input name='author' ref={authorInput} value={diary.author} onChange={StateHandler.setValue}/>
            </div>
            <div>
                <textarea name='content' ref={contentInput} value={diary.content} onChange={StateHandler.setValue}></textarea>
            </div>
            <div>
                <select name='emotion' value={diary.emotion} onChange={StateHandler.setValue}>
